...
with st.sidebar:
    ...
    Modern platforms optimize for engagement, unintentionally creating echo chambers where you only see perspectives similar to what you already believe.
    ...
    **The goal:** Help you make informed decisions by considering multiple viewpoints.
    """)
    ...
    try:
        ...
        st.caption("Start: `uvicorn api.main:app --reload`")
...
<div class="mission-box">
    ...
    <div class="mission-text">
        ...
        isn't showing you to help you make informed decisions by considering <strong>multiple sides</strong>.
        <br><br>
        <strong>We respect YouTube.</strong> We're a complementary tool addressing 
...
if analyze_button:
    if not video_url:
        ...
        status = st.empty()
        status.info("🧠 Initializing AI Pipeline... (Downloading & transcribing, please wait)")
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if metadata:
                    ...
                    <div class="video-summary-card">
                        ...
                        <div class="video-meta-row">
                            <div>📺 {metadata.get('channel_name', 'Unknown Channel')}</div>
                            <div>⏱️ {duration_str}</div>
                            <div>👁️ {views_str}</div>
                ...
                # =================================================================
                # COUNTER-PERSPECTIVES (3 BIG BOXES WITH VIDEOS INSIDE)
                # =================================================================
                ...
                if counter_arguments:
                    for counter in counter_arguments:
                        ...
                        # Verified Videos Section (INSIDE THE COUNTER CONTAINER)
                        ...
                        if suggested_videos:
                            ...
                            st.markdown("</div>", unsafe_allow_html=True)  # Close videos-section
                        else:
                            st.info("⚠️ No high-quality sources found for this counter-perspective.")
                        
                        st.markdown("</div>", unsafe_allow_html=True)  # Close counter-container
